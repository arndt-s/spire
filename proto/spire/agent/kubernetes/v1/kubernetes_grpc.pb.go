...
const (
	ExternalJWTSigner_Metadata_FullMethodName  = "/spire.agent.kubernetes.v1.ExternalJWTSigner/Metadata"
	ExternalJWTSigner_FetchKeys_FullMethodName = "/spire.agent.kubernetes.v1.ExternalJWTSigner/FetchKeys"
	ExternalJWTSigner_Sign_FullMethodName      = "/spire.agent.kubernetes.v1.ExternalJWTSigner/Sign"
)
...
var ExternalJWTSigner_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "spire.agent.kubernetes.v1.ExternalJWTSigner",
	...
	Metadata: "spire/agent/kubernetes/v1/kubernetes.proto",
}
